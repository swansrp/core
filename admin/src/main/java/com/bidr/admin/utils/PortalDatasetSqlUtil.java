package com.bidr.admin.utils;

import com.bidr.admin.constant.dict.JoinTypeDict;
    ...
    public static void parseSql(String sql, String tableId, List<SysPortalDataset> datasetList,
        ...
        if (plainSelect.getJoins() != null) {
            for (Join join : plainSelect.getJoins()) {
                ...
                String joinType = join.isInner() ? JoinTypeDict.INNER.getValue() : join.isLeft() ? JoinTypeDict.LEFT.getValue() : join.isRight() ? JoinTypeDict.RIGHT.getValue() : join.isFull() ? JoinTypeDict.FULL.getValue() : "JOIN";
