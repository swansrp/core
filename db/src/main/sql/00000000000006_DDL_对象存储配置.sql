...
INSERT INTO `sys_config` (`config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES
 ...
 ('对象存储桶名称', 'OSS_BUCKET', 'tanya', '0', NULL, '2024-02-26 09:35:11', NULL, '2024-02-26 09:35:11', '上传路径 桶名称'),
 ('对象存储接入地址', 'OSS_ACCESS_ENDPOINT', 'http://49.232.132.116:10022', '0', NULL, '2024-02-26 09:35:11', NULL, '2024-02-26 09:35:11', '访问域名'),
 ('对象存储接入key', 'OSS_ACCESS_KEY', 'UX5E9Jm7ma2CXDv1gFnQ', '0', NULL, '2024-02-26 09:35:11', NULL, '2024-02-26 09:35:11', 'OSS APP KEY'),
 ('对象存储接入秘钥', 'OSS_ACCESS_SECRET', 'glj4I7vsdggEElt2mA4FNLSMyaBcTdq5V9geZRGN', '0', NULL, '2024-02-26 09:35:11', NULL, '2024-02-26 09:35:11', 'OSS APP SECRET')
/
