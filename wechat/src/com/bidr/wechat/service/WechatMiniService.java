...
public class WechatMiniService {
    ...
    public LoginRes login(WechatMiniLoginReq req) {
        ...
        LoginRes loginRes = syncAccountService.loginOrReg(userInfo.getOpenId(), userInfo.getUnionId(),
    ...
    @PostConstruct
    protected void init() {
        String miniAppId = frameCacheService.getParamValueAvail(WechatConst.WECHAT_MINI_APP_ID);
        String miniSecret = frameCacheService.getParamValueAvail(WechatConst.WECHAT_MINI_APP_SECRET);
