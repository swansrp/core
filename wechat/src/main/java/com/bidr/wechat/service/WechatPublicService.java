...
public class WechatPublicService {
    ...
    protected void init() {
        String aesKey = frameCacheService.getParamValueAvail(WechatParamConst.WECHAT_PUBLIC_AES_KEY);
        String publicAppId = frameCacheService.getParamValueAvail(WechatParamConst.WECHAT_PUBLIC_APP_ID);
        signatureToken = frameCacheService.getParamValueAvail(WechatParamConst.WECHAT_PUBLIC_TOKEN);
        try {
