...
public class AcMenuSchema extends BaseMybatisSchema<AcMenu> {
    static {
        ...
        setInitData("INSERT INTO `ac_menu` (`menu_id`, `pid`, `grand_id`, `key`, `ancestors`, `client_type`, `title`, `show_order`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `update_by`, `remark`) VALUES\n\t(9, NULL, 1, 9, '#', '0', '表格配置', 6, 'portal', '', '', '0', '0', 1, '1', '1', NULL, 'InsertRowAboveOutlined', '000001', '000001', '');");
        ...
        setInitData("INSERT INTO `ac_menu` (`menu_id`, `pid`, `grand_id`, `key`, `ancestors`, `client_type`, `title`, `show_order`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `update_by`, `remark`) VALUES\n\t(14, 2, 1, 14, '#', '0', '部门-权限管理', 5, 'dept', '/framework/views/MainContent/SystemManage/PermissionMaintenance/DeptPermissionMaintenance', '', '0', '0', 1, '1', '1', NULL, 'SettingOutlined', '000001', '000001', '');");
        setInitData("INSERT INTO `ac_menu` (`menu_id`, `pid`, `grand_id`, `key`, `ancestors`, `client_type`, `title`, `show_order`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `update_by`, `remark`) VALUES\n\t(15, 2, 1, 15, '#', '0', '个人权限查看', 6, 'userPermit', '/framework/views/MainContent/SystemManage/PermissionMaintenance/UserPermit/userPermit.vue', '', '0', '0', 1, '1', '1', NULL, 'SettingOutlined', '000001', '000001', '');");
        setInitData("INSERT INTO `ac_menu` (`menu_id`, `pid`, `grand_id`, `key`, `ancestors`, `client_type`, `title`, `show_order`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `update_by`, `remark`) VALUES\n\t(16, 2, 1, 16, '#', '0', '个人权限申请', 7, 'apply', '/framework/views/MainContent/SystemManage/PermissionMaintenance/PermitApply', '', '0', '0', 1, '1', '1', NULL, 'SettingOutlined', '000001', '000001', '');");
        ...
        setInitData("INSERT INTO `ac_menu` (`menu_id`, `pid`, `grand_id`, `key`, `ancestors`, `client_type`, `title`, `show_order`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `update_by`, `remark`) VALUES\n\t(28, 9, 1, 28, '#', '0', '表单配置', 1, 'config', '/framework/views/MainContent/PortalConfig', '', '0', '0', 1, '1', '1', NULL, 'InsertRowAboveOutlined', '000001', '000001', '');");
        setInitData("INSERT INTO `ac_menu` (`menu_id`, `pid`, `grand_id`, `key`, `ancestors`, `client_type`, `title`, `show_order`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `update_by`, `remark`) VALUES\n\t(29, 9, 1, 29, '#', '0', '动态表格', 2, 'forge', '/framework/views/MainContent/dynamic/forge/index.vue', '', '0', '0', 1, '1', '1', NULL, 'SettingOutlined', '000001', '000001', '');");
        setInitData("INSERT INTO `ac_menu` (`menu_id`, `pid`, `grand_id`, `key`, `ancestors`, `client_type`, `title`, `show_order`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `update_by`, `remark`) VALUES\n\t(30, 9, 1, 30, '#', '0', '动态数据集', 3, 'dataset', '/framework/views/MainContent/dynamic/dataset/index.vue', '', '0', '0', 1, '1', '1', NULL, 'SettingOutlined', '000001', '000001', '');");
        setInitData("INSERT INTO `ac_menu` (`menu_id`, `pid`, `grand_id`, `key`, `ancestors`, `client_type`, `title`, `show_order`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `update_by`, `remark`) VALUES\n\t(31, 9, 1, 31, '#', '0', '动态表单', 4, 'form', '/framework/views/MainContent/dynamic/form/manage.vue', '', '0', '0', 1, '1', '1', NULL, 'SettingOutlined', '000001', '000001', '');");
        setInitData("INSERT INTO `ac_menu` (`menu_id`, `pid`, `grand_id`, `key`, `ancestors`, `client_type`, `title`, `show_order`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `update_by`, `remark`) VALUES\n\t(32, NULL, 1, 31, '#', '0', '缓存管理', 4, 'redis', '/framework/views/MainContent/redis/index.vue', '', '0', '0', 1, '1', '1', NULL, 'SettingOutlined', '000001', '000001', '');");
    }
}
