...
/**
 * Title: UserGroupBindAdminController
...
public class UserGroupBindAdminController extends BaseBindAdminController<AcGroup, AcUserGroup, AcUser, AcGroup, AccountRes> {
