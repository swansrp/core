 ...
 */
@Api(tags = "系统管理 - 人员 - 角色管理")
@RestController("AdminUserRoleBindController")
@RequestMapping(value = "/web-admin-user")
@RequiredArgsConstructor
public class AdminUserRoleBindController extends BaseBindAdminController<AcUser, AcUserRole, AcRole, AccountRes, RoleRes> {
    ...
    public List<MenuTreeRes> getMenuTree(String customerNumber) {
        return adminUserRoleBindService.getUserMenuTree(customerNumber);
    }
}
